...
class MemberTest < ActiveSupport::TestCase
  def setup
    @member = Member.new(first_name: "FirstName",last_name:"LastName", birth_date: "2008-08-20", phone: "514-345-5678",
    postal_code: "H2P 2G3", address: "1234 marquette", gender:"M", user_id: 1)
  end
